<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if(isset($_POST['product_id']) && isset($_POST['title']) && isset($_POST['description']) && isset($_POST['price']) && isset($_POST['discount_price']) 
            && isset($_POST['stock']) && isset($_POST['color']) && isset($_POST['type']) && isset($_POST['size']) && isset($_POST['availability']) && isset($_POST['token'])){
            ...
            try{
                ...
                if(isset($_SESSION[Session::$KEY_EC_TOKEN])){
                    ...
                    if($token_session == $token){
                        ...
                        if($product_id != "" && $title != "" && $price != "" && $type != ""){
                            ...
                            if($class_products->edit_product($product_id,$title,$description,$price,$discount_price,$stock,$color,$size,$type,$availabilty,$array_image)){
                                $error=0;
                            }else{
                                $error=1;
                            }
