            ...
            try{
                ...
                if(isset($_SESSION[Session::$KEY_EC_TOKEN])){
                    ...
                    if($token_session == $token){
                                ...
                                <div class="col-md-7 pl-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 p-0 text-center">
                                            <div class="form-group p-0 m-0 mt-3" id="container-button-view-'.$product_id.'">
                                                '.$button.'
                                            </div>
                                        </div>
                                    </div>
                        ...
                        /* Toast not logged in */
                        // $format.='
                        //     <div aria-live="polite" aria-atomic="true" style="position: relative; min-height: 60px;display:none" class="container-toast mt-4">
