$(document).ready(function(){
    ...
    $("#btn_print").click(function(){
        ...
        header="<div class='mb-4'><b>Report By Product Type</b><br><b>From:</b> "+from+"<br><b>To:</b> "+to+"<br><b>Report Date:</b> "+year+"-"+formattedMonth+"-"+day+"</div>";
