...
<head>
    ...
    <title>Admin / Report by product type</title>
    <?php 
...
<body>
    ...
    <main class="main" id="main">
        ...
        <div class="pagetitle" <?php echo $dictionary->get_dir($lang); ?>>
            ...
            <h1><?php echo $dictionary->get_lang($lang,$KEY_REPORT_BY_PRODUCT_TYPE); ?></h1>
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><?php echo $dictionary->get_lang($lang,$KEY_REPORT_BY_PRODUCT_TYPE); ?></li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                    ...
                    <div class="table-responsive">
                        <table class="table" id="table_report">
                            <thead class="thead-light">
                                <tr>
                                    <th>#</th>
                                    <th><?php echo $dictionary->get_lang($lang,$KEY_PRODUCT_TYPE); ?></th>
